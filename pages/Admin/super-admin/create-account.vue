<template>
  <div
    class="flex items-center justify-center min-h-screen pt-32 pb-12 bg-center bg-cover"
    style="background-image: url(&quot;/CET%20Faculty.jpg&quot;)"
  >
    <div class="w-full max-w-md p-8 mx-auto bg-white rounded-lg shadow-2xl">
