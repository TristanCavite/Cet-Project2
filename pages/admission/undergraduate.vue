<template>
  <main class="pb-4 bg-stone-200">
    ...
    <div class="relative flex items-center w-full border-b-2 font-playfair">
      ...
      />
      <div class="absolute flex items-center top-28 md:top-40 left-6 md:left-[120px] h-10 w-40 md:h-28 md:w-128 bg-gray-700/90">
        <span class="pl-2 text-xl text-white md:pl-5 md:text-6xl">Undergraduate</span>
      </div>
    </div>
    ...
    <div class="w-full h-auto mx-auto mt-10 mb-12 border-2 shadow-2xl md:mt-16 md:w-304 bg-neutral-50">
      ...
      <div
        ...
        class="px-10 mt-10 mb-5 space-y-4 text-sm leading-relaxed text-justify text-gray-800 font-roboto"
      ></div>
    </div>
  </main>
</template>
