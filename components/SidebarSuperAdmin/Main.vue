        ...
        <ul class="space-y-2">
          ...
          <li>
            <NuxtLink
              ...
              class="block px-3 py-2 transition duration-300 rounded hover:text-yellow-400"
              :class="['block px-3 py-2 hover:text-yellow-400', isActive('/admin/super-admin/manage_accounts') ? 'active' : '']"
            >
              Manage Accounts
            </NuxtLink>
          </li>
          <li>
            <NuxtLink
              ...
              class="block px-3 py-2 transition duration-300 rounded hover:text-yellow-400"
              :class="['block px-3 py-2 hover:text-yellow-400', isActive('/admin/super-admin/manage_news') ? 'active' : '']"
            >
              Manage News
            </NuxtLink>
          </li>
